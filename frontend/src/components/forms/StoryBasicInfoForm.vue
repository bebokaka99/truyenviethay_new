  ...
  <div class="story-basic-info-form">
    <div class="form-group">
      ...
      <input 
        ...
        @input="updateField('ten_truyen', $event.target.value)" 
        class="form-input" 
        required 
      >
    ...
    <div class="form-group">
      ...
      <input 
        ...
        @input="updateField('tac_gia', $event.target.value)" 
    ...
    <div class="form-group">
      ...
      <textarea 
        ...
        @input="updateField('mo_ta', $event.target.value)" 
        rows="8" 
        class="form-input" 
...
const coverImagePreview = ref<string | null>(props.modelValue.anh_bia instanceof File 
  ? URL.createObjectURL(props.modelValue.anh_bia) 
  : null
);
const fileError = ref('');

// Đã loại bỏ defaultCoverUrl

watch(() => props.modelValue.anh_bia, (newFile) => {
  if (newFile instanceof File) {
    coverImagePreview.value = URL.createObjectURL(newFile);
  } else if (newFile === null) {
    coverImagePreview.value = null; // Đặt về null khi không có file
  }
});
